...
├── images/            Website imagery, generated portraits, and project figures
...
Public asset paths are stable, so approved files can replace images without component edits:
...
- Project figures supplied in the Peizhi, Chengyu, Keyi, and Marshall website materials are stored locally as WebP assets under `public/images/projects/`.
...
Some other confirmed project imagery remains linked to supplied author project pages and GitHub repositories. `ResponsiveImage.astro` displays a neutral fallback if a remote asset is unavailable.
...
Also replace generated people/project placeholders, approved logos, and profile links as official material becomes available.
